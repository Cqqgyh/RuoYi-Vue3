  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      ...
      <el-form ref="dictRef" :model="form" :rules="rules" label-width="100px">
        <el-form-item label="供应商编码" prop="supplierCode">
          <el-input v-model.trim="form.supplierCode" placeholder="请输入供应商编码" maxlength="255"/>
        </el-form-item>
        <el-form-item label="供应商名称" prop="supplierName">
          <el-input v-model.trim="form.supplierName" placeholder="请输入供应商名称" maxlength="255"/>
        </el-form-item>
        ...
        <el-form-item label="微信号" prop="wxCode">
          <el-input v-model.trim="form.wxCode" placeholder="请输入邮件" maxlength="255"/>
        </el-form-item>
...
function getList () {
  ...
  getListPage(proxy.addDateRangeMode(queryParams.value, addDateRangeMode.value)).then(response => {
